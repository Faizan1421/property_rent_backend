...
router
  .route("/users")
  .get(verifyJWT, checkRole("admin"), getAllSellers); // it will get all users and sellers
router.route("/users/:id/verification").post(verifyJWT, checkRole("admin"), verification); 
