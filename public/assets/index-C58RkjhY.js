      ...
      He({
        ...
        queryFn: async () => {
          try {
            ...
            return de.success("Token is Valid"), u.data.success == !0, u.data;
          } catch (u) {
            u.response && u.response.status === 415 && t(!0),
              de.error(u.response.data.message || "Something went wrong");
          }
        ...
        He({
          ...
          queryFn: async () => {
            try {
              ...
              if (t.response && t.response.status === 401) return null;
              de.error(t.response.data.message || "Something went wrong");
            }
          },
          refetchOnWindowFocus: !1,
        }),
        y.jsx("div", { children: " ProfilePage" })
      );
    };
  function Mm(e) {
    return (
...
` +
          ...
          y.jsxs("div", {
            ...
            children: [
              y.jsx("div", {
                className: "w-20 h-20 ",
                children: y.jsx("img", {
                  src: `${(d = s == null ? void 0 : s.owner) != null && d.avatar ? ((p = s == null ? void 0 : s.owner) == null ? void 0 : p.avatar) : "/avatar.png"}`,
  ...
  const lg = { duration: 500, smooth: !0 },
                                    ...
                                    y.jsx("div", {
                                      ...
                                      children: y.jsx("div", {
                                        ...
                                        children: y.jsx("img", {
                                          ...
                                          src: `${(O = w == null ? void 0 : w.sender[0]) != null && O.avatar ? ((k = w == null ? void 0 : w.sender[0]) == null ? void 0 : k.avatar) : "/avatar.png"} `,
                                        }),
                                      }),
                                    }),
                                    y.jsxs("div", {
    ...
    KL = () => {
      ...
      return y.jsx("div", {
        children: y.jsx(QL, { filteredConversations: n }),
      });
    },
    XL = () => {
      var t;
