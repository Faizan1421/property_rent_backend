const Slide = () => {
  return (
    <div className="hidden md:block w-[100%] h-[80vh] bg-gradient-to-b from-black via-black to-black bg-opacity-50 bg-contain md:bg-cover bg-no-repeat md:bg-center  " 
