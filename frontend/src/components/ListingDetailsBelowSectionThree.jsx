  ...
  return (
    ...
    <div className="flex flex-col border-[1px] border-gray-100 rounded-lg p-4  mb-10">
        ...
        <div className="flex gap-2 font-semibold">
        {
            ...
            <span  className="w-fit h-fit bg-blue-100 text-sm lg:text-sm mb-2 p-2 rounded-md text-black" key={index}>{amenities}</span>
        )
        }
        </div>
    ...
    <div className="flex flex-col border-[1px] border-gray-100 rounded-lg p-4 ">
        ...
        <h1 className="text-lg lg:text-xl font-semibold mb-6">{listingDetails?.highlight}</h1> 
        <h1  className="text-sm lg:text-sm mb-2 ">{listingDetails?.highlightDesc}</h1>  
    </div>
    </div>
  )
}
